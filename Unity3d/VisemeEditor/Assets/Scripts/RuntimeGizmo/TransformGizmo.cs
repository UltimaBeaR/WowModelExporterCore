...
namespace RuntimeGizmos
{
    ...
    public class TransformGizmo : MonoBehaviour
    {
        ...
        public KeyCode SetMoveType = KeyCode.None;
        public KeyCode SetRotateType = KeyCode.None;
        public KeyCode SetScaleType = KeyCode.None;
        public KeyCode SetSpaceToggle = KeyCode.None;
        public KeyCode SetPivotModeToggle = KeyCode.None;
        ...
        public event Action<Transform> TargetAdded;
        public event Action<Transform> TargetRemoved;
        ...
        void TransformSelected()
        {
            if (mainTargetRoot != null)
            {
                ...
                // Добавил проверку на alt чтобы не конфликтовало с перемещением камеры по alt
                if (nearAxis != Axis.None && (Input.GetMouseButtonDown(0) && !Input.GetKey(KeyCode.LeftAlt) && !Input.GetKey(KeyCode.RightAlt)))
                {
